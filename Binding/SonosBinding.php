...
namespace Modules\Sonos\Binding;

/**
 * Class SonosBinding
 * @package App\Bindings\Sonos
 */
class SonosBinding
{
    ...
    /**
     * SonosBinding constructor.
     * @param        $Sonos_IP
     * @param string $Sonos_Port
     */
...
// On assigne les param�tres aux variables d'instance.
     ...
     * @param        $SOAP_service
     * @param        $SOAP_action
     * @param string $SOAP_arguments
     * @param string $XML_filter
     * @return mixed
     */
